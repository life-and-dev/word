---
description: Many Bible translations blur the line between offerings and sacrifices. Discover what the Hebrew word zebach reveals about the true cost of a sacrifice.
...
A sacrifice is a special type of [offering](offerings.md) that requires the death of a person or an animal.
...
The Hebrew word zebach (זֶבַח) comes from the root word zabach, which means ["to slaughter" or "to kill an animal"](https://biblestudycompany.com/reader/strongs/2077/hebrew).

A sacrifice has to cost the worshipper something, otherwise it is an offence to God:
...
Paul deliberately uses the paradox of a "living sacrifice":
...
If a sacrifice requires death by definition, then a "living sacrifice" is a contradiction. Paul resolves it by pointing back to an earlier argument:
...
The paradox is resolved: the believer is physically alive, but has died to sin. Presenting the body as a "living sacrifice" means surrendering a life that now belongs entirely to God. Paul describes the same reality elsewhere:
...
A [sacrifice](#defining-a-sacrifice) is a specific blood offering, rooted in the Hebrew word *zebach*, that requires death and must genuinely cost the one who offers it. In the New Testament, Paul reframes this principle for the believer: the [living sacrifice](#modern-sacrifices) of Romans 12:1-2. The death required is the death of the sinful self, leaving the body alive yet surrendered entirely to God.
